...
?>
         <button class="btn btn-secondary" onclick="window.location.href = 'pedidos.php';" style="display: block; margin: 0 auto;">Volver a Pedidos</button>
        <br>
         ...
         <div class="container-fluid">
            ...
            ?>
            <?php include 'listardetallePedido.php'; ?>
            </div>
         </div>
         <div class="container-fluid">
            <div class="row">                    
