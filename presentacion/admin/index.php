...
<style>
    ...
    <input class="form-control mr-sm-2" type="date" name="fecha_busqueda" placeholder="Buscar pedidos" aria-label="Buscar" required>
    ...
    <table>
        ...
        <?php include '../../negocio/listarPedidos.php'; ?>
